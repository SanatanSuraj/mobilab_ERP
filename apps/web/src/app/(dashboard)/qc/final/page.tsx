...
/**
 * Final QC — filters /qc/inspections?kind=FINAL_QC. Batch-level gate
 * before dispatch; CoA issuance lives on the inspection detail page.
 */

export default function QcFinalPage() {
  const inspectionsQuery = useApiQcInspections({ kind: "FINAL_QC", limit: 200 });
  ...
  if (inspectionsQuery.isLoading) {
    return (
      <div className="p-6 max-w-[1400px] mx-auto space-y-6">
        <PageHeader
          title="Final QC Inspections"
          description="FQC — batch-level gate before dispatch"
        />
